            ...
            <div className="w-10/12">
                <div className="w-8/12 float-left">
                    ...
                    <div className="mt-4">
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Kurier - Poczta Polska</h1>
                            <h1 className="inline-block mt-4 text-center pl-1 font-light text-sm align-middle h-full">(20 zł)</h1>
                        </div>
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            <span className="pl-4 text-4xl align-middle hover:text-primary inline-block h-full"
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Odbiór osobisty w salonie</h1>
                        ...
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Paczkomaty 24/7</h1>
                            <h1 className="inline-block mt-4 text-center pl-1 font-light text-sm align-middle h-full">(12 zł)</h1>
                        </div>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Płatność online</h1>
                            <h1 className="inline-block mt-4 text-center pl-1 font-light text-sm align-middle h-full">(bezpłatnie)</h1>
                        </div>
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            <span className="pl-4 text-4xl align-middle hover:text-primary inline-block h-full"
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Przelew tradycyjny</h1>
                            <h1 className="inline-block mt-4 text-center pl-1 font-light text-sm align-middle h-full">(bezpłatnie)</h1>
                        </div>
                        <div className="w-full h-16 pt-1 border-2 border-gray-100 mb-1 align-middle ">
                            <span className="pl-4 text-4xl align-middle hover:text-primary inline-block h-full"
                            ...
                            <h1 className="inline-block mt-4 text-center pl-6 font-light text-sm align-middle h-full">Przy odbiorze</h1>
                            <h1 className="inline-block mt-4 text-center pl-1 font-light text-sm align-middle h-full">(15 zł)</h1>
                        </div>
                    </div>
                </div>
                <div className="mt-[60px] mr-20 bg-m_gray py-6 w-3/12 float-right px-6">
                    ...
                    <div className="text-right w-6/12 float-right">
                        ...
                        }, deliveryPrice + paymentPrice).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, " ").replace('.', ', ')}</h1>
                    </div>
                    <Link to="/dostawaiplatnosc">
                        <button
                            className="hover:bg-primary hover:text-white bg-green-600 text-white w-full mt-10 px-6 py-3 font-normal block">Zamów
                        </button>
                    </Link>
                </div>
            </div>
