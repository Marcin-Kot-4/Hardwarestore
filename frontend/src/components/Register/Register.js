...
const Register = () => {
    ...
    function register () {
        let city = formAddressValues.city;
        let dateOfBirth = formValues.birthdate;
        let email = formValues.email;
        let houseNumber = formAddressValues.houseNumber;
        let name = formValues.name;
        let password = formValues.password;
        let postalCode = formAddressValues.zipCode;
        let street = formAddressValues.street;
        let surname = formValues.lastname;
        ...
        axios
            .post("http://localhost:8080/api/auth/signup", {
                city, dateOfBirth, email, houseNumber, name, password, postalCode, street, surname, username
            })
            .then((response) => {
                if (response.data) {
